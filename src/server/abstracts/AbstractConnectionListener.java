...
public abstract class AbstractConnectionListener {
    ...
    public void addConnectionObserver(ClientConnectionListener clientConnectionListener) {
        connectionListeners.add(clientConnectionListener);
    }

    public void removeConnectionObserver(ClientConnectionListener clientConnectionListener) {
